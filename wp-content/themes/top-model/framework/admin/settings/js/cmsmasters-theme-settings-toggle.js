...
(function ($) { 
	...
	if (($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') || ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'fullwidth')) {
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'c_nav') {
		$('#' + cmsmasters_settings.shortname + '_woocommerce_cart_dropdown').parents('tr').hide();
	} else {
		$('#' + cmsmasters_settings.shortname + '_woocommerce_cart_dropdown').parents('tr').show();
	}

	/* Woocommerce Settings Field Change */
	$('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]').on('change', function () {
		if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'c_nav') {
			$('#' + cmsmasters_settings.shortname + '_woocommerce_cart_dropdown').parents('tr').hide();
		} else {
