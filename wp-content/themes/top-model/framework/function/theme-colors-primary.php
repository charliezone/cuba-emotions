...
function top_model_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.custom_subscribe .wysija-input {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['top-model' . '_' . $scheme . '_color']) . ", 0.08) !important;
	}
	...
	{$rule}.cmsmasters_widget_project .cmsmasters_slider_post_read_more:hover, 
	...
	{$rule}.cmsmasters_slider_post a .cmsmasters_slider_post_date,
	...
	{$rule}.project_details_item_desc .cmsmasters_project_category a, 
	...
	{$rule}.cmsmasters_post_default a:hover .cmsmasters_post_date .published,
	{$rule}.cmsmasters_post_timeline a .cmsmasters_post_date .published,
	{$rule}.cmsmasters_post_timeline a .cmsmasters_post_date .published .cmsmasters_post_day,
	...
	{$rule}.cmsmasters_project_puzzle .project_outer:hover .project_inner {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['top-model' . '_' . $scheme . '_link']) . ", 0.9);
	}
	...
	{$rule}.widget_custom_posts_tabs_entries .cmsmasters_tabs .published,
	...
	{$rule}.project_details_item_desc .cmsmasters_project_category a:hover, 
	{$rule}#wp-calendar caption:before,
	{$rule}input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]),
	{$rule}.cmsmasters_profile .cmsmasters_img_rollover_wrap .cmsmasters_open_post_link > span:hover,
	{$rule}.cmsmasters_comment_item .comment-edit-link,
	{$rule}.cmsmasters_comment_item .cmsmasters_comment_item_cont_info > a,
	{$rule}.cmsmasters_slider_post .cmsmasters_img_rollover .cmsmasters_open_post_link > span:hover,
	{$rule}.cmsmasters_slider_project .cmsmasters_img_rollover .cmsmasters_open_post_link > span:hover,
	{$rule}.cmsmasters_project_grid .cmsmasters_img_rollover .cmsmasters_open_post_link > span:hover,
	...
	{$rule}.post .preloader[class^=\"cmsmasters_theme_icon_\"], 
	{$rule}.post .preloader[class*=\" cmsmasters_theme_icon_\"] {
	...
	{$rule}.cmsmasters_widget_project .cmsmasters_slider_post_read_more, 
	...
	{$rule}.widget_custom_posts_tabs_entries .cmsmasters_tabs .cmsmasters_tab li, 
	...
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_project_header .cmsmasters_slider_project_title a,
	{$rule}.cmsmasters_slider_project .cmsmasters_slider_post_read_more,
	{$rule}.cmsmasters_slider_post .cmsmasters_slider_post_date, 
	{$rule}.cmsmasters_slider_post a:hover .cmsmasters_slider_post_date,
	...
	{$rule}.cmsmasters_post_timeline a:hover .cmsmasters_post_date .published,
	{$rule}.cmsmasters_post_timeline a:hover .cmsmasters_post_date .published .cmsmasters_post_day,
	...
	{$rule}.header_mid .search_wrap.search_opened .search_bar_wrap {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['top-model' . '_' . $scheme . '_heading']) . ", 0.95);
	}
	
	
	{$rule}.cmsmasters_project_grid .project_img_wrap .cmsmasters_project_details,
	{$rule}.cmsmasters_slider_project .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover,
	{$rule}.cmsmasters_slider_post .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover,
	...
	{$rule}.cmsmasters_profile .cmsmasters_img_rollover_wrap:hover .cmsmasters_img_rollover {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['top-model' . '_' . $scheme . '_heading']) . ", 0.8);
	}
	
	{$rule}.post.cmsmasters_puzzle_type .preloader:after {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['top-model' . '_' . $scheme . '_heading']) . ", 0.6);
	}
	...
	{$rule}.cmsmasters_slider_post .cmsmasters_img_rollover .cmsmasters_open_post_link,
	{$rule}.cmsmasters_slider_project .cmsmasters_img_rollover .cmsmasters_open_post_link,
	{$rule}.cmsmasters_project_grid .cmsmasters_img_rollover .cmsmasters_open_post_link,
	...
	{$rule}.cmsmasters_project_grid .project_img_wrap .cmsmasters_project_details .project_details_item > div,
	{$rule}.cmsmasters_button, 
	{$rule}.cmsmasters_button:hover, 
	{$rule}.button, 
	{$rule}input[type=submit], 
	...
	{$rule}.cmsmasters_sitemap_wrap .cmsmasters_sitemap > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.sidebar .widget, 
	{$rule}.border_list li, 
	{$rule}.cmsmasters_footer_default .footer_inner, 
	...
	{$rule}.cmsmasters_stats.stats_mode_circles .cmsmasters_stat_wrap .cmsmasters_stat .cmsmasters_stat_inner {
		-webkit-box-shadow:inset 0 0 0 1px " . $cmsmasters_option['top-model' . '_' . $scheme . '_border'] . ";
		box-shadow:inset 0 0 0 1px " . $cmsmasters_option['top-model' . '_' . $scheme . '_border'] . ";
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['top-model' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['top-model' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
";
	...
	return apply_filters('top_model_theme_colors_primary_filter', $custom_css);
}
