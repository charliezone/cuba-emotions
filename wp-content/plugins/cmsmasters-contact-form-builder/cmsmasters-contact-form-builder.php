...
class Cmsmasters_Form_Builder {
	...
	public function cmsmasters_contact_form_builder_activation_compatibility() {
		if ( 
			...
			wp_die( 
				__("Your theme doesn't support CMSMasters Contact Form Builder plugin. Please use appropriate CMSMasters theme.", 'cmsmasters_form_builder'), 
				__("Error!", 'cmsmasters_form_builder'), 
				array( 
					'back_link' => 	true 
				) 
			);
	...
	public function cmsmasters_contact_form_builder_compatibility_warning() {
		echo "<div class=\"notice notice-warning is-dismissible\">
			<p><strong>" . __("CMSMasters Contact Form Builder plugin was deactivated, because your theme doesn't support it. Please use appropriate CMSMasters theme.", 'cmsmasters_form_builder') . "</strong></p>
		</div>";
	}
}
