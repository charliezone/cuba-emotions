...
function top_model_get_admin_page() {
	global $pagenow;
...
function top_model_default_tab() {
	$current_page = top_model_get_admin_page();
...
function top_model_get_the_tab() {
	global $pagenow;
	
	$default_tab = top_model_default_tab();
...
function top_model_settings_page_header() {
