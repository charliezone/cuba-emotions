...
function top_model_gutenberg_module_fonts($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module General Font Styles ******************/
	...
	{$editor} .wp-block-quote.is-large,
	{$editor} .wp-block-quote.is-style-large {
		font-size:" . ((int) $cmsmasters_option['top-model' . '_quote_font_font_size'] + 4) . "px;
		line-height:" . ((int) $cmsmasters_option['top-model' . '_quote_font_line_height'] + 4) . "px;
	}
...
add_filter('top_model_theme_fonts_filter', 'top_model_gutenberg_module_fonts');
