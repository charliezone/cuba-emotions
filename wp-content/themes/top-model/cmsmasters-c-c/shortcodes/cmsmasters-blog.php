...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'top-model');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'top-model');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'top-model');
