...
class Cmsmasters_Content_Composer { 
	...
	function cmsmasters_composer_enqueue_scripts($hook) {
		...
		/* Start cmsmasters_heading Translations */
			...
			'heading_field_custom_check' => 					__('Set Custom Font Size for Small Screens', 'cmsmasters_content_composer'),
			'heading_field_width_monitor' => 					__('Monitor Width', 'cmsmasters_content_composer'),
			'heading_field_custom_font_size' => 				__('Custom Font Size', 'cmsmasters_content_composer'),
			'heading_field_size_zero_note' => 					__('number, in pixels (default value if empty or 0)', 'cmsmasters_content_composer'),
			'heading_field_custom_line_height' => 				__('Custom Line Height', 'cmsmasters_content_composer'),
		...
		/* Start cmsmasters_featured_block Translations */
			...
			'featured_field_border_radius_descr' =>				__('Enter featured block border radius', 'cmsmasters_content_composer'),			'column_field_box_shadow_title' =>					__('Box Shadow', 'cmsmasters_content_composer'),
...
";
	...
	public function cmsmasters_content_composer_activation_compatibility() {
		if ( 
			...
			wp_die( 
				__("Your theme doesn't support CMSMasters Content Composer plugin. Please use appropriate CMSMasters theme.", 'cmsmasters_content_composer'), 
				__("Error!", 'cmsmasters_content_composer'), 
				array( 
					'back_link' => 	true 
				) 
			);
	...
	public function cmsmasters_content_composer_compatibility_warning() {
		echo "<div class=\"notice notice-warning is-dismissible\">
			<p><strong>" . __("CMSMasters Content Composer plugin was deactivated, because your theme doesn't support it. Please use appropriate CMSMasters theme.", 'cmsmasters_content_composer') . "</strong></p>
		</div>";
	}
}
