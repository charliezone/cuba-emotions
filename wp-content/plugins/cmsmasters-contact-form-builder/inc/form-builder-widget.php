...
class WP_Widget_Custom_Contact_Form extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('fromname'); ?>"><?php _e('Email From Name', 'cmsmasters_form_builder'); ?>:<br />
			...
			</label><br /><small><?php _e('Enter the From Name, which will be displayed into the From field of the incoming email before your domain name.', 'cmsmasters_form_builder'); ?></small>
		</p>
		<p>
