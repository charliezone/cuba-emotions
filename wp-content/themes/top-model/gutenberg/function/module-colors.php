...
function top_model_gutenberg_module_colors($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Colors Scheme Rules ******************/
	...
	{$editor} div.wp-block ul > li:before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_bg']) . "
	}
	
	{$editor} blockquote:before,
	{$editor} .wp-block-quote:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_hover']) . "
	}
	
	{$editor} .wp-block-quote,
	.editor-styles-wrapper .wp-block-freeform blockquote,
	.editor-styles-wrapper .wp-block-freeform blockquote p {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_heading']) . "
	}
	...
	.editor-styles-wrapper .wp-block-freeform table tbody tr td {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['top-model' . '_default_border']) . "
	}
	
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) th,
	{$editor} .wp-block-table.is-style-stripes tr:nth-child(odd) td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_alternate']) . "
	}
	/* Finish Table Colors */
...
/***************** Start Gutenberg Module General Colors Scheme Rules ******************/
	...
	{$editor} .wp-block-latest-comments .wp-block-latest-comments__comment-date {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_color']) . "
	}
	...
	.editor-styles-wrapper .wp-block-file .wp-block-file__textlink .editor-rich-text__tinymce {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_link']) . "
	}
	...
	.editor-styles-wrapper select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['top-model' . '_default_hover']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_heading']) . "
	}
	
	{$editor} .wp-block-pullquote {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['top-model' . '_default_heading']) . "
	}
	...
	{$editor} .wp-block-pullquote.is-style-solid-color {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_bg']) . "
	}
	...
	{$editor} .wp-block-separator.is-style-dots:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_border']) . "
	}
	
	{$editor} .wp-block-separator:not(.is-style-dots):before {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_border']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_link']) . "
	}
	...
	{$editor} .wp-block-file a.wp-block-file__button:active {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_bg']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_hover']) . "
	}
	
	{$editor} .wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color):not(.has-background) {
		" . cmsmasters_color_css('color', $cmsmasters_option['top-model' . '_default_link']) . "
		" . cmsmasters_color_css('background-color', $cmsmasters_option['top-model' . '_default_bg']) . "
		" . cmsmasters_color_css('border-color', $cmsmasters_option['top-model' . '_default_link']) . "
	}
...
add_filter('top_model_theme_colors_secondary_filter', 'top_model_gutenberg_module_colors');
